      ...
      <AnimatedSection>
        ...
        <div className="md:hidden w-full">
          ...
          <div className="flex mt-[44px] z-11 bg-white items-center justify-around px-1 py-5 w-full">
            ...
            <div className="flex gap-2 items-center font-[700] text-black">{mobileIndex + 1} <div className="h-0.5 w-8 bg-[#D9D9D9]" /><div className=' text-black/70'>{cards.length}</div></div>
            <div className="h-full flex items-center justify-center">
              <button
