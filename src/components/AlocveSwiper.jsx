...
function FitnessSwiper() {
  ...
  return (
    <AnimatedSection>
      {/* Mobile View */}
      <div className="w-full flex flex-col mt-10 md:hidden">
        <div className="relative">
          ...
          <div className="w-full absolute bottom-0 py-3 backdrop-blur-md flex items-center justify-center z-10">
            <span className="text-white font-bold text-[18px] leading-6 text-center">
              {fitnessSlides[activeIndex].caption}
            </span>
          </div>
        </div>
        {/* Text Section */}
        <div className="w-full bg-[#020C22] p-5 flex flex-col items-center">
      ...
      <div className="container fitness-swiper md:mb-10 w-full h-[280px] md:h-[570px] mx-auto flex-col lg:flex-row mt-12 lg:gap-x-8 hidden md:flex">
        ...
        <div className="flex flex-col justify-center lg:justify-center h-full">
          <div className="z-20 relative -bottom-[149px] right-[70px] max-w-md bg-[#020C22] p-8 md:p-10 text-white font-satoshi text-[40px] leading-[48px] text-left flex h-auto">
            <span>
