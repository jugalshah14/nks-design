      ...
      <div className="container fitness-swiper md:mb-10 w-full mx-auto flex-col lg:flex-row mt-12 lg:gap-x-8 flex">
        <div className="flex flex-col items-center w-full md:w-[804px]">
          <div className="relative w-full md:w-[804px]">
            ...
            <div className="w-full absolute bottom-0 left-0 p-3 md:p-5 backdrop-blur-md text-white font-semibold text-2xl z-10">
              <span className="text-[17px] leading-[20px]">{fitnessSlides[activeIndex].caption}</span>
        ...
        <div className="flex flex-col justify-center lg:justify-center h-full">
          <div className="z-20 md:relative md:-bottom-[149px] right-[70px] max-w-md bg-[#020C22] p-8 md:p-10 text-white font-satoshi text-[22px] md:text-[40px] leading-[28px] md:leading-[48px] text-center md:text-left flex h-auto">
            <span>
