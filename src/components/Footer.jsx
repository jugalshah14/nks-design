...
export default function Footer() {
    return (
        <div className='container max-w-7xl mx-auto px-24 py-20 bg-white'>
            <div className='grid grid-cols-2 gap-30'>
                <div className=''>
                    <h2 className="project-overview-title text-[56px] !text-[#22252E] mb-8">
                        <span className="orange-color">Contact </span>Us
                    </h2>
                    <p className="font-[400]  text-[14px] leading-5 !text-[#5C5F68]">
                    ...
                    <h2 className="font-stoshi font-[700] leading-7 text-[24px] !text-[#22252E] mt-12 mb-4">
                        Alcove Realty
                    </h2>
                    <p className="font-[400]  text-[14px] leading-5 !text-[#5C5F68]">
                    ...
                    <a className='flex items-center gap-4 px-4 py-3 border border-[#EDEDED] mt-8 cursor-pointer'>
                        ...
                        <span className='ml-auto font-[400] text-[20px] leading-7 text-[#144D78]'>+91 80124 13411</span>
                    </a>
                    <a className='flex items-center gap-4 px-4 py-3 border border-[#EDEDED] mt-4 cursor-pointer'>
                        ...
                        <span className='ml-auto font-[400] text-[20px] leading-7 text-[#144D78]'>inquire@alcove.in</span>
                    </a>
                </div>
                <div>
                    <p className='text-[#222222] font-[700] text-[20px] leading-7 mb-7'>Write to us</p>
                    <form action={"#"}>
                        ...
                        <button type='submit' className="mt-10 relative bg-[#144D78] hover:bg-blue-800 transition rounded-sm text-white font-medium inline-flex items-center gap-2 overflow-hidden">
            ...
            <div className='mt-30 flex justify-between items-center'>
                ...
                <p className='font-[400] text-[14px] leading-5 text-[#5C5F68]'>All rights reserved © Alcove Realty</p>
