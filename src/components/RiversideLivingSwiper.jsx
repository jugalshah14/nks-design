...
export default function RiversideLivingSwiper() {
    ...
    const renderCard = (slide, index) => (
        <div key={index} className='relative flex flex-col items-center pt-15 md:!min-w-[600px]'>
    ...
    return (
        <div ref={containerRef} className="relative md:h-[170vh] container mx-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
            ...
            {/* Mobile Slider */}
            <div className="md:hidden pt-10 px-4">
                <Slider
                    {...settings}
                >
                    {data.map(renderCard)}
