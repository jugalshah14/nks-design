            ...
            <div className='relative'>
                ...
                <div className='container mx-auto'>
                    <div className="relative z-10 text-center w-full p-[48px] bg-white">
                        ...
                        <SlideUp delay={0.4} className="project-overview-title text-center md:pb-[28px] md:pb-[0px]"><span className="orange-color">2 BHK's </span>Customers </SlideUp>
                    </div>
                    <SlideUp delay={0.6}>
                        <div className='flex flex-col md:flex-row px-[30px] pb-[100px]'>
                            <div className='flex flex-col md:flex-row w-full justify-between'>
                                <div className='relative flex flex-col pl-0 md:pl-[50px] p-[20px] md:p-[50px] gap-[10px] md:gap-[32px] !pb-0'>
                                    ...
                                    <div>
                                        <h1 className='text-left text-[18px] md:text-[24px] leading-[24px] md:leading-[28px] text-satoshi font-[700]'>Siddharth Das</h1>
                                        <p className='text-black/50 text-left text-[14px] md:text-[16px] leading-[20px] text-satoshi font-[400]'>Owner of flat in Serenity</p>
                                    </div>
                                    <div>
                                        <h1 className='text-black/50 text-left text-[14px] md:text-[16px] leading-[20px] text-satoshi font-[400]'>BHK Type</h1>
                                        <p className='text-left text-[18px] md:text-[24px] leading-[28px] text-satoshi font-[400]'>3BHK</p>
                                    </div>
                                    <div>
                                        <h1 className='text-black/50 text-left text-[14px] md:text-[16px] leading-[20px] text-satoshi font-[400]'>No of Family Members</h1>
                                        <p className='text-left text-[18px] md:text-[24px] leading-[28px] text-satoshi font-[400]'>5</p>
                                    </div>
                                    <div>
                                        <h1 className='text-black/50 text-left text-[14px] md:text-[16px] leading-[20px] text-satoshi font-[400]'>Unit area</h1>
                                        <p className='text-left text-[18px] md:text-[24px] leading-[28px] text-satoshi font-[400]'>56 m2  - 76 m2</p>
                                    </div>
                                </div>
                        ...
                        <div className='flex flex-col-reverse md:flex-row px-[30px] pb-[100px]'>
                            ...
                            <div className='md:pl-[64px] flex flex-col-reverse md:flex-row w-full justify-between'>
                                ...
                                <div className='relative flex flex-col pl-0 md:pl-[50px] p-[20px] md:p-[50px] gap-[10px] md:gap-[32px] !pb-0'>
                                    <Image src="/assets/linee.svg" alt="line" width={140} height={3} className="absolute top-0 left-0"/>
                                    <div>
                                        <h1 className='text-left text-[18px] md:text-[24px] leading-[24px] md:leading-[28px] text-satoshi font-[700]'>Neha Mohapatra</h1>
                                        <p className='text-black/50 text-left text-[14px] md:text-[16px] leading-[20px] text-satoshi font-[400]'>Owner of flat in Serenity</p>
                                    </div>
                                    <div>
                                        <h1 className='text-black/50 text-left text-[14px] md:text-[16px] leading-[20px] text-satoshi font-[400]'>BHK Type</h1>
