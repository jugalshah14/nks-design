        ...
        <div className="max-md:w-[100%] overflow-hidden sticky z-999 top-0 bg-white flex gap-2 space-x-5 border-t border-b border-[#22252e19] py-6 pb-6 md:py-5 md:pb-5 px-4 md:px-0" id="scroll-spy">
            <div className='!flex items-center ml-auto justify-center'>
                <ScrollLink
                    ...
                    id="amenities"
                >
                    <div className="spy-label py-2 cursor-pointer flex flex-col justify-center items-center gap-2 text-[16px] md:text-[20px] font-satoshi font-[700] whitespace-nowrap leading-6 md:leading-[27px] text-gray-400 relative m-0 hover:text-[#22252e] transition-all duration-300">
                        Amenities
