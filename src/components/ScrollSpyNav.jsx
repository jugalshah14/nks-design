...
export default function ScrollSpyNav() {
    ...
    return (
        <div className="max-md:w-[100%] overflow-hidden sticky z-999 top-0 bg-white flex justify-center gap-2 space-x-5 border-t border-b border-[#22252e19] py-6 pb-6 md:py-10 md:pb-12" >
