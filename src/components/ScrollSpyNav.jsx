...
export default function ScrollSpyNav() {
  useScrollSpySync({
    SCROLL_AREA,
    containerId: "scroll-spy",
    spyActiveLinkClass: "spy-link-active",
  });

  return (
    <AnimatedSection
      className="hide-scrollbar max-md:w-[100%] overflow-auto sticky z-999 top-0 bg-white flex gap-2 space-x-5 border-t border-b border-[#22252e19] py-6 pb-6 max-md:px-5 md:py-10 md:pb-12"
      id="scroll-spy"
    >
      ...
      <div className="!w-fit !flex items-center justify-center min-w-[10px] min-h-[10px]">
        <Image
          src="/assets/icons/rectangle_divider.svg"
          alt="Arrow"
          width={10}
          height={10}
          className="m-0"
