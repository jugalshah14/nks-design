...
export default function FAQHeader({ title }) {
    ...
    return (
        <div className='max-md:w-[100%] max-lg:w-[40%] flex flex-col items-start pb-10 md:pb-20 text-base font-bold leading-none mr-auto'>
            ...
            <h1 className="max-md:w-full mt-5 md:mt-9 ml-9 text-[56px] leading-18 text-center text-[#22252E] font-[400] font-cormorant max-md:mt-10 max-md:ml-2.5 max-md:text-4xl">
                {title}
            </h1>
