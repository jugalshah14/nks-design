    ...
    return (
        <main className='relative'>
            <section className="bg-[#F4F6FE] flex flex-col items-center px-5 sm:px-14 pt-[100px] sm:pt-[150px] pb-4">
                ...
                <h1 className="text-[#22252E] font-[IvyMode] max-sm:text-[100px] max-sm:leading-[100px] max-sm:mt-5 font-[400] text-[150px] leading-[150px] text-center opacity-10">
                    FAQs
                </h1>
                <Searchbox
                    inputProps={{
                ...
                {faqsData.map((item, i) => (
                    <div key={`${item.id}-${i}`} className={`${i % 2 == 0 ? 'bg-white' : 'bg-[#F3F6F8]'}`}>
                        <div className={`container mx-auto px-4 lg:px-24 py-20 relative flex items-center flex-col`}>
                            <p className='text-center text-[56px] font-[400] font-[IvyMode] leading-18 text-[#22252E]'>{item.label}</p>
